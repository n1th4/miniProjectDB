            ...
            while($row=mysqli_fetch_array($result)) {
                echo "<tbody>";
                    echo "<tr>";
                        ...
                        echo "<td>" .$row["empTel"] .  "</td> ";
                        echo "<td>" .$row["empAddress"] .  "</td> ";
                        echo "<td>" .$row["typeEmp"] .  "</td> ";
                        //ดูรายชื่อ Employee แต่ละแผนก
                        echo "<td align='center'><a class='btn btn-info' href='employeePage.php?ID=$row[0]&act=view' aria-label='Settings'>
                        <i class='fa fa-eye' aria-hidden='true'></i></a></td> ";
                        echo "<td align='center'><a class='btn btn-warning' href='employeePage.php?ID=$row[0]&act=edit' aria-label='Settings'>
